...
function showToast(msg, type) { const c = document.getElementById('toast-container'); if(!c) return; const t = document.createElement('div'); t.className = 'toast' + (type === 'warning' ? ' warning' : ''); t.textContent = msg; c.appendChild(t); setTimeout(() => t.remove(), 4200); }
    ...
    // ── ABBREVIATION MAP ──
    const ABBREV = {
      'OHP': 'Overhead Press', 'RDL': 'Romanian Deadlift', 'DB': 'Dumbbell', 'BB': 'Barbell',
      'EZ': 'EZ-Curl Bar', 'Tri': 'Triceps', 'Lat': 'Lateral', 'HIIT': 'High-Intensity Interval Training',
      'LISS': 'Low-Intensity Steady State', 'Pec Deck': 'Pec Deck Fly Machine', 'Hack Squat': 'Hack Squat Machine'
    };

    // ── MUSCLE TARGETS PER WORKOUT TYPE ──
    const MUSCLE_TARGETS = {
      'Push': 'Chest / Shoulders / Triceps', 'Pull': 'Back / Biceps / Rear Delts',
      'Legs': 'Quadriceps / Hamstrings / Glutes / Calves', 'Upper': 'Chest / Back / Shoulders / Arms',
      'Lower': 'Quads / Hamstrings / Glutes / Calves', 'Full Body': 'All Major Muscle Groups',
      'Chest': 'Pectorals / Front Delts', 'Back': 'Lats / Traps / Rhomboids',
      'Shoulders': 'All 3 Delt Heads / Traps', 'Arms': 'Biceps / Triceps / Forearms',
      'Circuit': 'Full Body / Cardiovascular', 'Cardio + Core': 'Core / Cardiovascular',
      'HIIT + Core': 'Core / Cardiovascular', 'Core + Cardio': 'Core / Cardiovascular'
    };
